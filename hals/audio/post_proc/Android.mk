...
ifneq ($(BOARD_OPENSOURCE_DIR), )
   ...
   LOCAL_C_INCLUDES += device/xiaomi/spes/hals/audio/hal \
...
ifneq ($(BOARD_OPENSOURCE_DIR), )
  ...
  LOCAL_C_INCLUDES += device/xiaomi/sm6225-common/hals/audio/hal \
                      device/xiaomi/sm6225-common/hals/audio/hal/audio_extn
endif # BOARD_OPENSOURCE_DIR
